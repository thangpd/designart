...
$current_uri = substr($current_uri, 0, 4);
        ...
        <div class="wp-ds-ldpage">
            <div class="wp-block-contact landing-st contact-st">
                ...
                <div class="text-center group-btn">
                    ...
                    <a href="<?php if($current_uri == '/en/'): echo "mailto:designarttokyo@camronpr.com"; else: echo "mailto:press@designart.jp"; endif; ?>" class="btn btn-bg black">Contact for Press<i class="icons fa fa-angle-right"></i></a>
                </div>
