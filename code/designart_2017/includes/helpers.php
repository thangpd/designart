...
?>
<div class="language-dropdown dropdown" id="custome-multi-languagle" data-current="<?php echo $languagle ?>" data-home="<?php echo home_url(); ?>">
    ...
    <ul class="dropdown-menu">
        ...
        <li><a href="javascript:void(0)" data-val="cn">中文</a></li>
    </ul>
    ...
    if (isset($_SERVER['REDIRECT_URL'])) {
        ...
        if ( preg_match('/^\/en$/', $redirect_url) ||
            ...
            if ( preg_match('/designart2017$/', home_url())) {
                $custom_page_name = 'DESIGNART2017 | TOP';
        ...
        if ( preg_match($reg, $redirect_url) ) {
            $custom_page_name = 'DESIGNART2017 | EXHIBITOR';
...
//            }
        ...
        $reg = '/\/(event-party)$/';
        if ( preg_match($reg, $redirect_url) ) {
            $custom_page_name = 'DESIGNART2017 | EVENT & PARTY';
...
//            }
        ...
        $reg = '/\/(architecture)$/';
        if ( preg_match($reg, $redirect_url) ) {
            $custom_page_name = 'DESIGNART2017 | ARCHITECTURE';
...
//            }
        ...
        $reg = '/\/(news)$/';
        if ( preg_match($reg, $redirect_url) ) {
            $custom_page_name = 'DESIGNART2017 | NEWS';
...
//            }
        ...
        if ( preg_match($reg, $redirect_url) ) {
            $custom_page_name = 'DESIGNART2017 | Artist & Brand';
...
//            }
        ...
        if ( preg_match($reg, $redirect_url, $maths) ) {
            ...
            if (isset($maths[2]) && !empty($maths[2])) {
                ...
                $custom_page_name = 'DESIGNART2017 | EXHIBITOR | '.$maths[2];
        ...
        if ( preg_match($reg, $redirect_url, $maths) ) {
            ...
            if (isset($maths[2]) && !empty($maths[2])) {
                ...
                $custom_page_name = 'DESIGNART2017 | NEWS | '.$custom_page->post_title;
                if (isset($custom_page)) {
        ...
        if ( preg_match($reg, $redirect_url, $maths) ) {
            ...
            if (isset($maths[2]) && !empty($maths[2])) {
                ...
                $custom_page_name = 'DESIGNART2017 | ARCHITECTURE | '.$maths[2];
                if (isset($custom_page)) {
        ...
        if ( preg_match($reg, $redirect_url, $maths) ) {
            ...
            if (isset($maths[2]) && !empty($maths[2])) {
                ...
                $custom_page_name = 'DESIGNART2017 | EVENT & PARTY | '.$maths[2];
                if (isset($custom_page)) {
        ...
        if ( preg_match($reg, $redirect_url, $maths) ) {
            ...
            if (isset($maths[2]) && !empty($maths[2])) {
                ...
                $custom_page_name = 'DESIGNART2017 | Artist & Brand | '.$maths[2];
                if (isset($custom_page)) {
