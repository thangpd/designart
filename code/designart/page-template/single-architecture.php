...
<?php
    ...
    if (!empty($custom_page)) {
        ...
        $title = $gallery = $description = $artists = $area = $map = '';
        ...
        if ( isset($map) && is_array($map) &&  !empty($map) ) {
            ...
            if (empty($map_url)) {
                ...
                if (isset($map['lat']) && isset($map['lng'])) {
                    $map_url .= '@'.$map['lat'].','.$map['lng'];
                }
            }
        }
        $name_cat = '';
	    ...
	    $venues = $text_artist = $text_venue = $description_bottom = '';
	    if(  class_exists('acf') ) :
        ...
        <div class="container">
            ...
            <div class="heading-title heading-style-01 padding-tb-60">
                <div class="title-wrapp">
                    <div class="first-letter">Architecture</div>
                    <h2 class="title case-1">Architecture</h2>
                </div>
            </div>
            <!-- infor detail -->
...
<!--                end venue-->
                ...
                ?>
                <div class="wp-btn text-center">
                    <a href="<?php echo home_url().'/architecture/' ?>" class="btn btn-line black">
...
<script type="text/javascript">
    jQuery(function($){
        ...
        $(document).ready(function () {
            $('#primary-menu').find('a[data-demo=item-3]').parent().addClass('current-menu-item');
        })
    })
</script>
<?php get_footer('top2') ?>