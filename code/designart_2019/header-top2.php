...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Poppins:400,400i,500,500i,600,600i,700,700i,800"
          rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="<?php echo URL_STATICS; ?>/libs/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css"
          href="<?php echo URL_STATICS; ?>/libs/font-awesome/css/font-awesome.min.css"/>
    <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/fancybox/3.2.5/jquery.fancybox.css">
    <link rel="stylesheet" href="<?php echo URL_STATICS; ?>/libs/fancybox/source/helpers/jquery.fancybox-thumbs.css"
    ...
    <header id="main_header" class="site-header main-header-page header-top-2">
        ...
        <div class="header-main">
            ...
            <div class="nav-collapse menu-pc">
                        ...
                        <ul id="primary-menu" class="menu">
                            ...
                            <li id="menu-item-543"
                                ...
                                <a href="<?php echo home_url() ?>/about/"
                                   data-demo="item-1"><?php echo translate_text_language( 'about designart' ) ?></a>
                            </li>
                            ...
                            <li id="menu-item-78"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-78 scroll-menu-item">
                                <a href="<?php echo home_url() ?>/exhibitor/"
                                   data-demo="item-2"><?php echo translate_text_language( 'exhibition' ) ?></a>
                            </li>
                            ...
                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-78 scroll-menu-item">
                                <a href="http://designart.jp/conference2019/" target="_blank"
                                   class="external"><?php echo translate_text_language( 'conference' ) ?></a>
                            </li>
                ...
                <!-- ./end .main-navigation -->
                <div class="btn-map"><a
                            href="https://www.google.com/maps/d/viewer?mid=1FFBUJ7kpkClWfUhbNioWGEH4kynf8Nuf&ll=35.66768702397678%2C139.72963319999997&z=13"><i
                                class="fa fa-map-marker"></i><?php echo translate_text_language('GUIDE MAP') ?></a></div>
            ...
            <div class="nav-collapse menu-sp">
                <ul class="nav-menu">
                    ...
                    <li>
                        ...
                        <a href="<?php echo get_home_url() ?>">
                            CONFERENCE <img src="<?php echo URL_STATICS; ?>/images/top/edit.png" alt=""
                                            class="img-edit"/>
                            <span>カンファレンス</span>
                        </a>
                    </li>
                ...
                <div class="block-info">
                    ...
                    <div class="language ">
						...
						generate_select_languagle( 'EN', 'JP', 'layou2' );
						?>
