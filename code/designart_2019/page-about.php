                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-right">
                                                <div class="desc">
                                                    ...
                                                    <p>
                                                        DESIGNART（デザイナート）は、ジャンルの垣根を超えて、デザインとアートを横断するモノやコトの素晴らしさを発信・共有してゆく活動です。
                                                    </p>
                                                    <p>「DESIGNART
                                                        TOKYO」は、その活動の場として2017年に始まった、毎年秋に開催するデザイン＆アートフェスティバル。世界屈指のミックスカルチャー都市である東京を舞台に、世界中からアート、デザイン、インテリア、ファッション、フードなどさまざまなジャンルのモノやコトが集結し、都内各所で多彩なプレゼンテーションを行います。各展示を回遊して街歩きが楽しめるのも、このイベントの魅力のひとつ。まさに、東京の街全体がデザイン＆アートミュージアムになる10日間です。

                                                    </p>
                                                    <p>
                                                        過去２年の開催によって、アートやデザインプロダクツを購入し、日常的に愛でるという文化が、東京の人々に着実に根付きつつあります。そこで３年目となる今年は、個人ではなく社会全体でアートを支える文化を成熟させるための活動をスタートします。
                                                    </p>
                                                    <p>「1% for
                                                        Art」は、公共建設の建築費の１%をパブリックアートの制作費用に充てるという、欧米諸国や韓国、台湾などで法制化されている文化制度です。この制度によって、人々が日常的にアートを鑑賞し、感動できる社会が実現するとともに、アーティストやデザイナーの雇用が創出されクリエイティブ産業を活性化させることができます。
                                                    </p>
                                                    <p>DESIGNART TOKYO
                                                        2019では、日本においてこの制度を実現するための多様なプロジェクトを展開するほか、会期を通じて法制化実現のための著名活動なども実施します。
                                                    </p>
                                    ...
                                    <div class="brand-wrapp">
                                                ...
                                                <div class="brand-list">
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a
                                                                    ...
                                                                    target="_blank"><img
                                                                        src="<?php echo URL_STATICS ?>/images/about/section1/01_ARTEK_logo_JPG.png"
                                                                        alt="logo-asahibuil">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a
                                                                    ...
                                                                    target="_blank"><img
                                                                        src="<?php echo URL_STATICS ?>/images/about/section1/02_Ayumi logo.png"
                                                                        alt="logo-askul">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="brand-item">
                                                        <div class="pic-wrap">
                                                            <a href="https://www.designsingapore.org/" target="_blank">
                                                                <img src="<?php echo URL_STATICS ?>/images/about/section1/03_design_singapore_council.png"
                                                    ...
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a
                                                                    ...
                                                                    target="_blank">
                                                                <img src="<?php echo URL_STATICS ?>/images/about/section1/04_DS_Logo_2019_reversed_RGB.png"
                                                                     alt="logo-dbrain">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a href="https://about.google/"
                                                                                 target="_blank">
                                                                <img src="<?php echo URL_STATICS ?>/images/about/section1/05_google.png"
                                                                     alt="logo-francfranc">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="brand-item">
                                                        <div class="pic-wrap">
                                                            <a href="https://hansen.co.il/en/" target="_blank">
                                                                <img src="<?php echo URL_STATICS ?>/images/about/section1/06_Hansen House.png"
                                                                     alt="logo-gervasoni">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a
                                                                    ...
                                                                    target="_blank">
                                                                <img src="<?php echo URL_STATICS ?>/images/about/section1/07_honda.png"
                                                                     alt="logo-panasonic">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a
                                                                    ...
                                                                    target="_blank">
                                                                <img src="<?php echo URL_STATICS ?>/images/about/section1/08_arab.png"
                                                    ...
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a href="https://landmarks.gov.il/"
                                                                                 target="_blank">
                                                                <img src="<?php echo URL_STATICS ?>/images/about/section1/09_Jerusalem_and_heritage.png"
                                                                     alt="logo-sony">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a
                                                                    ...
                                                                    target="_blank">
                                                                <img src="<?php echo URL_STATICS ?>/images/about/section1/10_Jerusalem__.png"
                                                                     alt="logo-space">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a
                                                                    ...
                                                                    target="_blank">
                                                                <img src="<?php echo URL_STATICS ?>/images/about/section1/11_logo-perrierjouet.png"
                                                                     alt="logo-tanseisha">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a
                                                                    ...
                                                                    target="_blank">
                                                                <img src="<?php echo URL_STATICS ?>/images/about/section1/12_rany.png"
                                                    ...
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a
                                                                    ...
                                                                    target="_blank">
                                                                <img src="<?php echo URL_STATICS ?>/images/about/section1/13_Sivans.png"
                                                                     alt="logo-volvostudioaoyama">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a
                                                                    ...
                                                                    target="_blank">
                                                                <img src="<?php echo URL_STATICS ?>/images/about/section1/14_SSYS_L.png"
                                                                     alt="logo-volvostudioaoyama">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a
                                                                    ...
                                                                    target="_blank">
                                                                <img src="<?php echo URL_STATICS ?>/images/about/section1/15_LOGO_TKYLAB.png"
                                                                     alt="logo-volvostudioaoyama">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a
                                                                    ...
                                                                    target="_blank">
                                                                <img src="<?php echo URL_STATICS ?>/images/about/section1/16_the_ginza.png"
                                                                     alt="logo-volvostudioaoyama">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a
                                                                    ...
                                                                    target="_blank">
                                                                <img src="<?php echo URL_STATICS ?>/images/about/section1/17_TOKYO MIDTOWN.png"
                                                                     alt="logo-volvostudioaoyama">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a
                                                                    ...
                                                                    target="_blank">
                                                                <img src="<?php echo URL_STATICS ?>/images/about/section1/18_volvo.png"
                                                                     alt="logo-volvostudioaoyama">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a
                                                                    ...
                                                                    target="_blank">
                                                                <img src="<?php echo URL_STATICS ?>/images/about/section1/19_LOGO_YSLA_1.png"
                                                                     alt="logo-volvostudioaoyama">
                                                            </a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="brand-block">
                                            ...
                                            <div class="col-right"><a
                                                        ...
                                                        target="_blank"><img
                                                            src="<?php echo URL_STATICS ?>/images/about/section2/8jwat.png"
                                                ...
                                                <div class="brand-list">
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a href="https://theartling.com/en/"
                                                                                 target="_blank"><img
                                                                        src="<?php echo URL_STATICS ?>/images/about/section2/1theartling.png"
                                                    ...
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a href="https://www.artprice.com/"
                                                                                 target="_blank"><img
                                                                        src="<?php echo URL_STATICS ?>/images/about/section2/2art.png"
                                                    ...
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a href="https://designanthologymag.com/"
                                                                                 target="_blank"><img
                                                                        src="<?php echo URL_STATICS ?>/images/about/section2/3desgn.png"
                                                    ...
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a href="https://www.designboom.com/"
                                                                                 target="_blank"><img
                                                                        src="<?php echo URL_STATICS ?>/images/about/section2/4desgbb.png"
                                                                        alt="section2-imhome">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a href="https://www.dezeen.com/"
                                                                                 target="_blank"><img
                                                                        src="<?php echo URL_STATICS ?>/images/about/section2/5dezeen.png"
                                                                        alt="section2-jdn">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a href="https://www.fashionsnap.com/"
                                                                                 target="_blank"><img
                                                                        src="<?php echo URL_STATICS ?>/images/about/section2/6fasion.png"
                                                    ...
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a href="http://imhome-style.com/"
                                                                                 target="_blank"><img
                                                                        src="<?php echo URL_STATICS ?>/images/about/section2/7imhome.png"
                                                                        alt="section2-pen"></a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a href="https://www.merci-magazine.com/"
                                                                                 target="_blank"><img
                                                                        src="<?php echo URL_STATICS ?>/images/about/section2/9merci.png"
                                                    ...
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a href="http://www.shift.jp.org/ja/"
                                                                                 target="_blank"><img
                                                                        src="<?php echo URL_STATICS ?>/images/about/section2/10sift.png"
                                                    ...
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a href="https://www.shotenkenchiku.com/"
                                                                                 target="_blank"><img
                                                                        src="<?php echo URL_STATICS ?>/images/about/section2/11sengoku.png"
                                                    ...
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a href="http://www.spoon-tamago.com/"
                                                                                 target="_blank"><img
                                                                        src="<?php echo URL_STATICS ?>/images/about/section2/12spoon.png"
                                                    ...
                                                    <div class="brand-item">
                                                        <div class="pic-wrap"><a href="https://www.wwdjapan.com"
                                                                                 target="_blank"><img
                                                                        src="<?php echo URL_STATICS ?>/images/about/section2/13wwwd.png"
                                                                        alt="section2-wwdjapan"></a>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <li> <!-- item-pickup-->
                                            <div class="row">
                                                <div class="wp-image img-cafe col-md-5">
                                                    <img src="<?php echo URL_STATICS ?>/images/about/goodcafe/about_cafegoods_specialdrink.jpg"
                                                         alt=""
                                    ...
                                    <div class="area-section">
                                        ...
                                        <div class="wp-content-inner row">
                                            <div class="wp-left col-md-4">
                                                <div class="wrap-img">
                                                    <img src="<?php echo URL_STATICS ?>/images/about/goodcafe/hyoushi.png"
                                                         alt=""
                                                         class="img-responsive ">
                                                </div>
                                            </div>
                                        ...
                                        <div class="wp-content-inner wp-content-img-left wp-content-img-left-1 row">
                                            <div class="wp-left col-md-4">
                                                <div class="wrap-img no-padding">
                                                    <img src="<?php echo URL_STATICS ?>/images/about/goodcafe/official_tshirt.jpg"
                                                         alt=""
                                                         class="img-responsive ">
                                                </div>
                                            </div>
                                    ...
                                    <div class="area-section">
                                        ...
                                        <div class="wp-content-inner wp-content-img-left row">
                                            <div class="left col-md-4">
                                                <div class="wrap-img no-padding">
                                                    <img src="<?php echo URL_STATICS ?>/images/about/goodcafe/flags.jpg"
                                                         alt=""
                                                         class="img-responsive ">
                                                </div>
                                            </div>
                                    ...
                                    <div class="area-section">
                                        <div id="aoyama-area">
                                            <div class="wp-content-area row">
                                                <div class="wp-left col-md-4">
                                                    <a href="#" class="">
                                                        <img src="<?php echo URL_STATICS ?>/images/about/program/program01.jpg"
                                                             alt="Aoyama Area" class="img-responsive">
                                                    </a>
                                                </div>
                                                <div class="wp-right col-md-8">
                                    ...
                                    <div class="area-section">
                                        <div id="jinguu-area">
                                            <div class="wp-content-area row">
                                                <div class="wp-left col-md-4">
                                                    <a href="#" class="">
                                                        <img src="<?php echo URL_STATICS ?>/images/about/program/program02.jpg"
                                            ...
                                            <div class="wp-content-area row">
                                                <div class="wp-left col-md-4">
                                                    <a href="#" class=" img-small">
                                                        <img src="<?php echo URL_STATICS ?>/images/about/program/program03.jpg"
...
" target="_blank">MORE
                                                        ...
                                                        <a class="multi-btn"
                                                           href="http://designart.jp/designarttokyo2019/exhibitor/deco-vondsransel/"
                                                           target="_blank">MORE
                                                            INFO</a><br><br>
                                                        TIMON<br>
                                    ...
                                    <div class="area-section">
                                        <div id="shibuya-area">
                                            <div class="wp-content-area row">
                                                <div class="wp-left col-md-4">
                                                    <a href="#">
                                                        <img src="<?php echo URL_STATICS ?>/images/about/program/program04.jpg"
                                                             alt="Shibuya Area" class="img-responsive">
                                                    </a>
                                                </div>
                                                <div class="wp-right col-md-8">
                                    ...
                                    <div class="area-section">
                                        <div id="shibuya-area">
                                            <div class="wp-content-area row">
                                                <div class="wp-left col-md-4">
                                                    <a href="#">
                                                        <img src="<?php echo URL_STATICS ?>/images/about/program/program05.jpg"
                                                             alt="Shibuya Area" class="img-responsive">
                                                    </a>
                                                </div>
                                                <div class="wp-right col-md-8">
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <a href="http://designart.jp/conference2019/" target="_blank">MORE
                                                            INFO</a>
                                                    </div>
                                    ...
                                    <div class="area-section">
                                        <div id="shibuya-area">
                                            <div class="wp-content-area row">
                                                <div class="wp-left col-md-4">
                                                    <a href="#">
                                                        <img src="<?php echo URL_STATICS ?>/images/about/program/program06.jpg"
                                                             alt="Shibuya Area" class="img-responsive">
                                                    </a>
                                                </div>
                                                <div class="wp-right col-md-8">
                                    ...
                                    <div class="area-section">
                                        <div id="shibuya-area">
                                            <div class="wp-content-area row">
                                                <div class="wp-left col-md-4">
                                                    <a href="#">
                                                        <img src="<?php echo URL_STATICS ?>/images/about/program/program07.jpg"
                                                             alt="Shibuya Area" class="img-responsive">
                                                    </a>
                                                </div>
                                                <div class="wp-right col-md-8">
                                            ...
                                            <div class="wp-content-area row">
                                                ...
                                                <div class="wp-right col-md-8">
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        1.マップをもらう<br>
                                                        スタンプラリーの台紙がついたDESIGNART TOKYO 2019 AREA
                                                        MAPを展示会場やインフォメーションセンターでゲット。 <br><br>
